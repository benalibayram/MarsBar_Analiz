...
for newcond_ind=1:size(combins, 1)
    ...
    cont_vals{cont_names_len + newcond_ind} = -diff(cell2mat(cont_vals(combins(newcond_ind, :))'));
end
...
sonucdosyasi = ['stat_struct_C15_' filtre_ismi ARname versiyon '_extra_kontrast'];
